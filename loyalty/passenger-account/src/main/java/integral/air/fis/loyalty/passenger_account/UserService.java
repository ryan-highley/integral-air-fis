 ...
 */
package integral.air.fis.loyalty.passenger_account;
...
/**
 * A {@link integral.air.fis.loyalty.passenger_account.User} service which we rest enable the routes defined in the XML file.
 */
@Named("userService")
